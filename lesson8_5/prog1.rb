questions = [
    ...
    "Случается ли вам проверять его корреспондецию и рыться в его вещах?",
    ...
    "Если вы на нгео обижены, то молчите по нескольку дней?",
...
results = [
    ...
    "В минуту слабости случается и вас устраивать сканадалы. Но, успокоившись, вы понимаете, " +
...
if (yes_answers >= 10)
    puts "Результат:",results[0],"\n"
elsif (yes_answers >= 5)
    puts "Результат:",results[1],"\n"
else
    puts "Результат:",results[2],"\n"
end
end
